      ...
      <section className="pt-24 pb-12 md:pb-24 relative overflow-hidden">
        ...
        >
          ...
          <motion.p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl" variants={itemVariants}>
            Personalized fitness and rehabilitation programs for every stage of life. Maximum of 3 clients per time slot for personalized attention and quality gym session.
          </motion.p>
          ...
          <motion.div className="grid grid-cols-3 gap-8 md:gap-12 w-full max-w-3xl" variants={containerVariants}>
            {[
              { icon: Heart, label: "For all age groups and Athletes" },
              { icon: Activity, label: "Semi-private Gym session" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div className="space-y-6" variants={containerVariants}>
              ...
              <motion.p className="text-lg text-muted-foreground leading-relaxed" variants={itemVariants}>
                Vertex represents the peak of health and performance, where science, movement, and precision come together. Beyond private fitness sessions, we combine evidence-based physiotherapy with athletic performance training for athletes, along with physiotherapy treatments for a wide range of musculoskeletal disorders and sports-related conditions.
              </motion.p>
        ...
        >
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" variants={containerVariants}>
            {[
              ...
              "Maximum of 3 clients per time slot",
              "Appointment-led sessions",
              "One-on-one expert supervision",
              "Personalized attention and quality gym/fitness session",
