          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div className="space-y-6" variants={containerVariants}>
              <motion.p className="text-lg text-muted-foreground leading-relaxed" variants={itemVariants}>
                Everyone is an athlete in their own way. Whether you’re recovering from an injury, building strength, or optimizing performance, we believe in developing long-term mobility, strength, and overall well-being.
              </motion.p>
              <motion.p className="text-lg text-muted-foreground leading-relaxed" variants={itemVariants}>
               Our integrated approach combines rehabilitation and fitness expertise with evidence-based coaching. We provide personalized (Gym/Physio) programs tailored to your unique needs — all under one roof. 
                </motion.p>
              <motion.div className="space-y-3 pt-6" variants={containerVariants}>
                {["Functional fitness", "Strength & conditioning", "Manual therapy", "Rehabilitation Support pre / post operation", "Mobility / Flexibility Improvement","Electrotherapy"].map((item, i) => (
